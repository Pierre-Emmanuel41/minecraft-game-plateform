...
import fr.pederobien.minecraft.game.platform.exceptions.configurations.TeamsAreTheSameException;
import fr.pederobien.minecraft.game.platform.impl.element.PlateformTeam;
