...
import fr.pederobien.minecraft.gameplateform.impl.editions.AbstractSimpleMapEdition;
...
public class GameEdition extends AbstractSimpleMapEdition {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (Plateform.getGameConfigurationContext().getGameConfiguration() == null) {
			sendNotSynchro(sender, EGameMessageCode.NO_CONFIGURATION_SETTED, (Object[]) args);
			return false;
		}
		return true;
	}
