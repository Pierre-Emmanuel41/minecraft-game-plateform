...
import fr.pederobien.minecraft.gameplateform.exceptions.ColorNotFoundException;
import fr.pederobien.minecraft.gameplateform.exceptions.PlayerNotFoundException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.PlayerAlreadyRegisteredException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.PlayerNotRegisteredException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.TeamNameForbiddenException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.TeamNotFoundException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.TeamWithSameColorAlreadyExistsException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.TeamWithSameNameAlreadyExistsException;
import fr.pederobien.minecraft.gameplateform.exceptions.configurations.TeamsAreTheSameException;
import fr.pederobien.minecraft.gameplateform.impl.element.PlateformTeam;
...
public class GameConfigurationHelper implements IGameConfigurationHelper {
	...
	public ITeam[] movePlayer(String playerName, String teamName) {
		...
		return movePlayer(checkPlayerRegistered(player), checkTeamExist(teamName), player);
	}

	@Override
	public void movePlayer(Player player, ITeam targetTeam) {
		movePlayer(checkPlayerRegistered(player), targetTeam, player);
	}
