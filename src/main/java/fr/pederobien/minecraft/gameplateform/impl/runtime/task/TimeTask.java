package fr.pederobien.minecraft.gameplateform.impl.runtime.task;
...
import fr.pederobien.minecraft.gameplateform.impl.observer.Observable;
import fr.pederobien.minecraft.gameplateform.impl.runtime.task.state.InitialTimeTaskState;
import fr.pederobien.minecraft.gameplateform.impl.runtime.task.state.PauseTimeTaskState;
import fr.pederobien.minecraft.gameplateform.impl.runtime.task.state.RunTimeTaskState;
import fr.pederobien.minecraft.gameplateform.interfaces.observer.IObservable;
...
import fr.pederobien.minecraft.gameplateform.interfaces.runtime.task.state.ITimeTaskState;
