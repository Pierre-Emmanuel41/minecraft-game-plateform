...
public enum EBorderMessageCode implements IMinecraftMessageCode {
	...
	// Code for command initialTime
	INITIAL_TIME_BORDER__EXPLANATION, INITIAL_TIME_BORDER__TIME_IS_MISSING, INITIAL_TIME_BORDER__INITIAL_DIAMETER_AT_THE_BEGINNING, INITIAL_TIME_BORDER__TIME_DEFINED,

	// Code for command startTime
	START_TIME_BORDER__EXPLANATION, START_TIME_BORDER__TIME_IS_MISSING, START_TIME_BORDER__BORDER_MOVES_AT_THE_BEGINNING, START_TIME_BORDER__START_TIME_DEFINED,

	// Code for command moveTime
	MOVE_TIME_BORDER__EXPLANATION, MOVE_TIME_BORDER__TIME_IS_MISSING, MOVE_TIME_BORDER__INSTANTLY_MOVE, MOVE_TIME_BORDER__MOVE_TIME_DEFINED;
