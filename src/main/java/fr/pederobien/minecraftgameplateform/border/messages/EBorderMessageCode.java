...
public enum EBorderMessageCode implements IMessageCode {
	...
	SPEED_BORDER__EXPLANATION, SPEED_BORDER__ON_TAB_COMPLETE, SPEED_BORDER__SPEED_IS_MISSING, SPEED_BORDER__SPEED_IS_NEGATIVE, SPEED_BORDER__SPEED_DEFINED,

	// Code for command startTime
	START_TIME_BORDER__EXPLANATION, START_TIME_BORDER__TIME_IS_MISSING;
