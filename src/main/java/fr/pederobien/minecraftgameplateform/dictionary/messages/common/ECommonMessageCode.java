...
public enum ECommonMessageCode implements IMessageCode {
	...
	COMMON_BAD_INTEGER_FORMAT, COMMON_BAD_BOOLEAN_FORMAT, COMMON_ARGUMENT_NOT_FOUND, COMMON_NOT_AVAILABLE_ARGUMENT, COMMON_NOT_AVAILABLE_COMMAND,
