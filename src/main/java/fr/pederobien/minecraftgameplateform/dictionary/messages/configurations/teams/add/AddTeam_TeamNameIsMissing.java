...
public class AddTeam_TeamNameIsMissing extends AbstractDynamicMessage {
	/**
	 * Message in French when any name has been furnished to create a team for a configuration.
	 */
	public static final IMessage FRENCH = new French();
	/**
	 * Message in English when any name has been furnished to create a team for a configuration.
	 */
