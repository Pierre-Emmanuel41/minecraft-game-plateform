...
public enum ETeamAddMessageCode implements IMessageCode {
	...
	ADD_PLAYER__EXPLANATION, ADD_PLAYER__TEAM_NAME_IS_MISSING, ADD_PLAYER__TEAM_DOES_NOT_EXIST, ADD_PLAYER__ANY_PLAYER_ADDED(Permission.ALL),
	ADD_PLAYER__ONE_PLAYER_ADDED(Permission.ALL), ADD_PLAYER__SEVERAL_PLAYERS_ADDED(Permission.ALL);
