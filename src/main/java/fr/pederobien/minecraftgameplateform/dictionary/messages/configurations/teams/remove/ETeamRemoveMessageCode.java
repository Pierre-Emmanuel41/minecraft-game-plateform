...
public enum ETeamRemoveMessageCode implements IMessageCode {
	...
	REMOVE_PLAYER__EXPLANATION, REMOVE_PLAYER__ALL_PLAYERS_REMOVED, REMOVE_PLAYER__ANY_PLAYER_REMOVED, REMOVE_PLAYER__ONE_PLAYER_REMOVED(Permission.ALL),
	REMOVE_PLAYER__SEVERAL_PLAYERS_REMOVED(Permission.ALL);
